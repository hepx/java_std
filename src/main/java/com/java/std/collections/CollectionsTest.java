package com.java.std.collections;
...
public class CollectionsTest {
	...
	public static void main(String[] args) {
		...
		Queue queue=Collections.asLifoQueue(new LinkedList(l));
		System.out.println("返回后进先出的视图："+queue);
		...
		System.out.println("88所在序号："+Collections.binarySearch(l, 88)); // 二分查找，必须保证list处于有序状态，查询成功返回序号，查不到返回负数
